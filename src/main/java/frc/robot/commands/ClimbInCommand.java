...
public class ClimbInCommand extends Command {
  private final ClimbPivotSubsystem climbPivotSubsystem;
  /** Creates a new ClimbCommand. */
  public ClimbInCommand(ClimbPivotSubsystem climbPivotSubsystem) {
  ...
  @Override
  public void execute() {
    climbPivotSubsystem.setVoltage(11);
  }
  ...
  public boolean isFinished() {
    return climbPivotSubsystem.isLimit();
  }
}
