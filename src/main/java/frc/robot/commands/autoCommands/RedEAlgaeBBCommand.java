...
public class RedEAlgaeBBCommand extends SequentialCommandGroup {
  ...
  public RedEAlgaeBBCommand(CommandSwerveDrivetrain drive, ElevatorSubsystem elevator, WristSubsystem wrist,
    ...
    addCommands(
        ...
        new ParallelCommandGroup(
            new SequentialCommandGroup(driveSubsystem.offsetAlignCommand(() -> TrajectoryConstants.RED_E_OFFSET),
                driveSubsystem.reefAlignCommand(() -> TrajectoryConstants.RED_E)),
            intakeSubsystem.setIntakeSpeed(0.1),
            elevatorSubsystem.setElevatorPositionCommand(() -> ElevatorConstants.L3_POSITION.magnitude()),
            wristSubsystem.setAngle(WristConstants.WRIST_SCORE_POSITION.magnitude())),
        ...
        new ParallelCommandGroup(
            new SequentialCommandGroup(driveSubsystem.offsetAlignCommand(() -> TrajectoryConstants.RED_E_OFFSET),
                driveSubsystem.reefAlignCommand(() -> TrajectoryConstants.RED_F)),
            intakeSubsystem.setIntakeSpeed(0.1),
            elevatorSubsystem.setElevatorPositionCommand(() -> ElevatorConstants.L3_POSITION.magnitude()),
            wristSubsystem.setAngle(WristConstants.WRIST_SCORE_POSITION.magnitude())),
