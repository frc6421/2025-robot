...
public class RedHRB extends SequentialCommandGroup {
  ...
  public RedHRB(CommandSwerveDrivetrain drive) {
    ...
    Trajectory driveToHTrajectory = TrajectoryGenerator.generateTrajectory(List.of(
        TrajectoryConstants.BLUE_A, 
        TrajectoryConstants.BLUE_B), 
        reverseConfig);
