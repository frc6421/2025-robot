...
public class RedHRBCommand extends SequentialCommandGroup {
  ...
  public RedHRBCommand(CommandSwerveDrivetrain drive, ElevatorSubsystem elevator, WristSubsystem wrist, IntakeSubsystem intake) {
    ...
    addCommands(
        driveSubsystem.reefAlignCommand(() -> ((TrajectoryConstants.RED_H).plus(new Transform2d(0.0, Units.inchesToMeters(7.5), new Rotation2d(0))))),
