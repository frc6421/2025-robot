...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        // joystick.back().and(joystick.x()).whileTrue(elevatorSubsystem.sysIdDynamic(Direction.kReverse));
        // joystick.back().and(joystick.y()).whileTrue(elevatorSubsystem.sysIdDynamic(Direction.kForward));
        // joystick.start().and(joystick.x()).whileTrue(elevatorSubsystem.sysIdQuasistatic(Direction.kReverse));
        // joystick.start().and(joystick.y()).whileTrue(elevatorSubsystem.sysIdQuasistatic(Direction.kForward));
        ...
        joystick.a().whileTrue(new RunCommand (()  -> elevatorSubsystem.setElevatorPosition(24)));
        joystick.a().onFalse(new InstantCommand(() -> elevatorSubsystem.stopElevator()));

        joystick.b().whileTrue(new RunCommand(() -> elevatorSubsystem.setElevatorPosition(0)));
