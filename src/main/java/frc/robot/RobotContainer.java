...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
                ...
                drivetrain.applyRequest(() -> drive.withVelocityX(xDriveSlew.calculate(-joystick.getLeftY() * MaxSpeed)) // Drive
                                                                                                                         // forward
                                                                                                                         // with
                                                                                                                         // negative
                                                                                                                         // Y
                                                                                                                         // (forward)
                        .withVelocityY(yDriveSlew.calculate(-joystick.getLeftX() * MaxSpeed)) // Drive left with
                                                                                              // negative X (left)
